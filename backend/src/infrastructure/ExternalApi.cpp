...
std::string ExternalApi::execCommand(const char* cmd) {
...
std::string ExternalApi::urlEncode(std::string_view value) {
    std::string escaped;
    for (char c : value) {
...
void ExternalApi::enrichBookData(Book& book) {
...
std::string ExternalApi::promptNLM(std::string_view moodQuery, const nlohmann::json& libraryBooks) {
